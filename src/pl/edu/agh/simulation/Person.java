...
public class Person {
	...
	public Person(Health health, int x, int y, int target) {
		this.x = x;
		this.y = y;
		this.health = health;
		this.timeToInfect = 0;
		...
		if (Math.abs(destX - x) > Math.abs(destY - y)) {
			if (destX < x) {
				if (Board.cells[this.getX()][this.getY()].getNeighbors().get(7).getCellType() == CellType.FREE
						|| Board.cells[this.getX()][this.getY()].getNeighbors().get(7).getCellType() == CellType.WALL) {
					this.makeStep(7);
				} else if (destX < y) {
					if ((Board.cells[this.getX()][this.getY()].getNeighbors().get(1).getCellType() == CellType.FREE
							|| Board.cells[this.getX()][this.getY()].getNeighbors().get(1)
					...
					if ((Board.cells[this.getX()][this.getY()].getNeighbors().get(5).getCellType() == CellType.FREE
							|| Board.cells[this.getX()][this.getY()].getNeighbors().get(5)
									.getCellType() == CellType.WALL)) {
						this.makeStep(5);
					} else {
						this.makeStep(1);
				...
				if (Board.cells[this.getX()][this.getY()].getNeighbors().get(3).getCellType() == CellType.FREE
						|| Board.cells[this.getX()][this.getY()].getNeighbors().get(3).getCellType() == CellType.WALL) {
					this.makeStep(3);
				} else if (destX < y) {
					if ((Board.cells[this.getX()][this.getY()].getNeighbors().get(1).getCellType() == CellType.FREE
							|| Board.cells[this.getX()][this.getY()].getNeighbors().get(1)
			...
			if (destY < y) {
				if (Board.cells[this.getX()][this.getY()].getNeighbors().get(1).getCellType() == CellType.FREE
						|| Board.cells[this.getX()][this.getY()].getNeighbors().get(1).getCellType() == CellType.WALL) {
					this.makeStep(1);
				} else if (destX < x) {
					if ((Board.cells[this.getX()][this.getY()].getNeighbors().get(7).getCellType() == CellType.FREE
							|| Board.cells[this.getX()][this.getY()].getNeighbors().get(7)
									.getCellType() == CellType.WALL)) {
						this.makeStep(7);
					} else {
						this.makeStep(3);
					...
					if ((Board.cells[this.getX()][this.getY()].getNeighbors().get(3).getCellType() == CellType.FREE
							|| Board.cells[this.getX()][this.getY()].getNeighbors().get(3)
									.getCellType() == CellType.WALL)) {
						this.makeStep(3);
					} else {
						this.makeStep(7);
				...
				if (Board.cells[this.getX()][this.getY()].getNeighbors().get(5).getCellType() == CellType.FREE
						|| Board.cells[this.getX()][this.getY()].getNeighbors().get(5).getCellType() == CellType.WALL) {
					this.makeStep(5);
				} else if (destX < x) {
					if ((Board.cells[this.getX()][this.getY()].getNeighbors().get(7).getCellType() == CellType.FREE
							|| Board.cells[this.getX()][this.getY()].getNeighbors().get(7)
	...
	private void contaminateNeighbours() {
		for (Cell x : Board.cells[this.getX()][this.getY()].getNeighbors()) {
			if (x.getCellType() == CellType.PERSON
					&& Board.getPerson(x.getX(), x.getY()).getHealth() == Health.SYMPTOMS) {
				if (Math.random() <= Disease.possibilityOfSpreading) {
	...
	private void contaminateNeighbourhood() {
		for (Cell x : Board.cells[this.getX()][this.getY()].getNeighbors()) {
			x.setTimeOfContamination(Disease.cellContaminationTime);
		}
	}
	...
	public static Node setFirstNode(int fromX, int fromY) {
		...
		for (int i = 1; i < Board.nodes.size(); i++) {
			...
			if (Board.calculateDistance(fromX, x, fromY, y) <= Board.calculateDistance(fromX, nearest.getX(), fromY,
					nearest.getY())) {
